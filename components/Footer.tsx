      ...
      <footer className="flex flex-col items-center justify-center text-center bg-red-700 p-10 text-white font-mono group">
        <div className="flex flex-col ">
          ...
          <a
            ...
            className="flex items-center justify-center pt-4 scale-150"
          >
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="hover:scale-150 transform duration-300 cursor-pointer fill-current animate-pulse hover:animate-none"
            >
